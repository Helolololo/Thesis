    ...
    Adapter.prototype.handleCommand = function (wantedCommand, args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        commands = this.getAcceptedCommands();
                        command = commands.find(function (c) { return c.command === wantedCommand; });
                        if (!command) return [3, 2];
                        return [4, command.handler(args)];
                    case 1: return [2, _a.sent()];
                    case 2: return [2, { success: false, message: "Command not found" }];
                }
            });
        });
    };
...
//# sourceMappingURL=AdapterTemplate.js.map
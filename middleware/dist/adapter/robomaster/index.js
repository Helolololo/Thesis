...
var Robomaster = (function (_super) {
                ...
                handler: function (args) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 2, , 3]);
                                return [4, this.sendMoveForwardCommand(args[1])];
                            case 1:
                                _a.sent();
                                return [2, {
                                        success: true,
    ...
    Robomaster.prototype.connect = function () {
    ...
    Robomaster.prototype.disconnect = function (s) {
        s.end();
    };
    Robomaster.prototype.sdk_cmd = function (s, msg) {
        var cmd = msg;
        s.write(cmd, 'utf-8');
    ...
    Robomaster.prototype.sendMoveForwardCommand = function (distance, direction) {
        var s = this.connect();
        ...
        var msg = "chassis move x ".concat(x, " y ").concat(y, " z ").concat(z, ";");
        this.sdk_cmd(s, msg);
        this.disconnect(s);
    };
    return Robomaster;

...
var MirAdapter = (function (_super) {
    ...
    function MirAdapter(ops) {
        ...
        _this.client = new mir_rest_calls_1.Mir100Client(_this.ops.authorization);
        return _this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.client.getMissions()];
                    case 1:
                        allMissions = _a.sent();
                        ...
                        keysMissions.forEach(function (key, index) {
                            if (allMissions[key].name === "Move to ".concat(positionName)) {
                                _this.client.deleteMissions(allMissions[key].guid);
                            }
                        });
                        return [4, this.client.postMissions({
                    ...
                    case 2:
                        ...
                        return [4, this.client.postMissionsActions(missionid, {
                                "action_type": "move",
                    ...
                    case 3:
                        ...
                        return [4, this.client.getMission_queue()];
                    case 4:
                        ...
                        return [4, this.client.postMission_queue({
                                "mission_id": missionid,
                                "priority": 0
                            })];
                    case 5:

...
var LoadConfiguration_1 = require("./LoadConfiguration");
        ...
        return __generator(this, function (_b) {
            ...
            switch (_b.label) {
                ...
                case 5:
                    ...
                    possibleAdaptersList[folder] = module_1;
                    _b.label = 6;
                case 6:
                    _a++;
                    return [3, 4];
                case 7:
                    _i++;
                    return [3, 2];
                case 8: return [2, (0, LoadConfiguration_1.processConfigs)(possibleAdaptersList, "configuration")];
                case 9:
                    err_1 = _b.sent();
                    console.error(err_1);
                    return [3, 10];
